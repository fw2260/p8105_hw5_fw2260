...
Make a plot showing the average estimate of $\hat \mu$ on the y-axis and the true value of $\mu$ on the x-axis. Overlay a second plot of the average estimate of $\hat \mu$ only in samples for which the null was rejected:
